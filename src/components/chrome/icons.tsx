 ...
 * one of the two chroma exceptions (mono at rest via .agent-mark). */
export const ClaudeStar = ({ size = 14 }: { size?: number }) => (
  <svg width={size} height={size} viewBox="0 0 100 100" fill="none" className="agent-mark shrink-0">
 ...
 * exception (mono at rest via .agent-mark). */
